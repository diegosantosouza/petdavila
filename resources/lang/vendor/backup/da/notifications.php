...
return [
    ...
    'cleanup_failed_subject' => 'Oprydning af backup for :application_name fejlede.',
    'cleanup_failed_body' => 'Der skete en fejl under oprydning af backup for :application_name',

    'cleanup_successful_subject' => 'Oprydning af backup for :application_name gennemført',
    'cleanup_successful_subject_title' => 'Backup oprydning gennemført!',
    'cleanup_successful_body' => 'Oprydningen af backup for :application_name på disken :disk_name er gennemført.',

    'healthy_backup_found_subject' => 'Alle backup for :application_name på disken :disk_name er OK',
    'healthy_backup_found_subject_title' => 'Alle backup for :application_name er OK',
    'healthy_backup_found_body' => 'Alle backup for :application_name er ok. Godt gået!',
    ...
    'unhealthy_backup_found_empty' => 'Denne applikation har ingen backup overhovedet.',
